...
??? success
    ...
    ```text
    [1] 点(2,0,3)と平面5x - y + 2z + 1 = 0の距離を求めよ
    ...
    [2] 平行な2平面 x - 3y + 4z - 2 = 0, x - 3y + 4z + 5 = 0との距離
    ※一方の平面の任意の点との距離を求めれば事足りる
    (2,0,0)は、 x - 3y + 4z - 2 = 0上の点である
    よって、点と平面との距離は

    |1*2 + 0 + 0 + 5| / √{1 + 9 + 16} = 7/√26


    [3] 3点 (2,0,0), (0,3,0), (0,0,4)を通る平面と原点(0,0,0)の距離を求めよ
      平面の方程式は
      x/2 + y/3 + z/4 = 1
      6x + 4y + 3z -12 = 0
