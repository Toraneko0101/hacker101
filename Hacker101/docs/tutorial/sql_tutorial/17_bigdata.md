...
??? success
    ...
    3 リアルタイム性のあるデータなら、ストリーム方式
      そうでないならバッチ処理を行い、処理サーバへデータ送信
    
    4 処理サーバでクレンジングを行う
      ⇒処理したデータを、デバイスに送り返すこともある

    5 バッチ処理や非同期転送で、蓄積サーバにデータ送信

    6 統計的手法や、機械学習を用いて分析を行う
    ```
...
## Q165 データ収集を行ってから、データを蓄積するまでの流れを知っていますか?
